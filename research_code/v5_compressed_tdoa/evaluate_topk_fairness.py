...
from research_code.shared.baselines import (
...
from research_code.dae_pipeline.evaluate import _estimate_delay_from_corr, gcc_standard
from research_code.shared.experiment_integrity import (
    assert_non_oracle_normalization,
    validate_model_output,
    validate_urban_batch,
)
from research_code.dae_pipeline.model import DAE
...
from research_code.v5_compressed_tdoa.topk_localization import (
...
def main():
    ...
    artifact_paths = {
        ...
        "topk_code": PROJECT_ROOT / "research_code/v5_compressed_tdoa/topk_localization.py",
        "shared_evaluator_code": PROJECT_ROOT / "research_code/dae_pipeline/evaluate.py",
        "task_baseline_code": PROJECT_ROOT / "research_code/shared/task_baselines.py",
    }
