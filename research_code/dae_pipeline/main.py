...
from research_code.dae_pipeline.train import train_with_cv
import pickle
from research_code.dae_pipeline.evaluate import (MonteCarloExperiment, UrbanLocalizationExperiment, plot_monte_carlo,
...
from research_code.dae_pipeline.model import (
    DAE,
...
from research_code.shared.signal_gen import SignalSimulator
from research_code.shared.baselines import build_traditional_baselines
from research_code.shared.task_baselines import (
...
from research_code.v5_compressed_tdoa.compressed_tdoa import (
...
from research_code.shared.experiment_cache import (
    load_static_baseline_cache,
    merge_method_comparison_results,
)
from research_code.dae_pipeline.experiment_profiles import apply_experiment_profile
from research_code.shared.experiment_integrity import (
...
BASELINE_RESULT_DIR = os.path.join(str(_LAYOUT_ROOT),
                                   "运行结果", BASELINE_RESULT_ID)
FREQ_TASK_RESULT_ID = os.path.join(
    "FreqDAE", "20260706_103701_FreqDAE_v1频率选择"
)
FREQ_TASK_RESULT_DIR = os.path.join(str(_LAYOUT_ROOT),
...
for seed_run_idx, current_seed in enumerate(SEED_LIST):
    ...
    if REUSE_STATIC_BASELINE_CACHE:
        cache_expected_config = {
            ...
            "baseline_code_fingerprint": code_fingerprint(
                str(_LAYOUT_ROOT),
                filenames=(
                    "research_code/shared/signal_gen.py", "research_code/dae_pipeline/evaluate.py", "research_code/shared/baselines.py",
                    "research_code/shared/task_baselines.py", "research_code/v5_compressed_tdoa/topk_localization.py",
                    "research_code/shared/experiment_integrity.py",
                ),
            ),
        }
        try:
    ...
    if is_last_seed:
        ...
        try:
            from research_code.dae_pipeline.export_results import export as export_result_tables
