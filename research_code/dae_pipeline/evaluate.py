...
from research_code.shared.experiment_integrity import validate_model_output, validate_urban_batch
...
def plot_method_comparison(method_data, metric_key="rmse", plot_kind="main",
    ...
    styles = {
        ...
        "GeoHybrid-B64-C48F16": dict(color="#e6550d", marker="D", linestyle="-", linewidth=1.45,
                                     label="GeoHybrid B64 C48/F16"),
        "GeoHybrid-B64-C40F24": dict(color="#fd8d3c", marker="d", linestyle="-", linewidth=1.40,
                                     label="GeoHybrid B64 C40/F24"),
        "GeoHybrid-B64-C32F32": dict(color="#fdae6b", marker="p", linestyle="-", linewidth=1.35,
                                     label="GeoHybrid B64 C32/F32"),
        "GeoHybrid-OverBudget-C64F64": dict(color="#636363", marker="D", linestyle="--", linewidth=1.30,
                                            label="GeoHybrid over-budget C64/F64"),
        "GeoHybrid-B64-C40F24-no-consistency": dict(color="#fdd0a2", marker="v", linestyle=":", linewidth=1.20,
                                                    label="GeoHybrid no consistency"),
        "GeoHybrid-B64-C40F24-no-uncertainty": dict(color="#f16913", marker=">", linestyle="-.", linewidth=1.20,
                                                    label="GeoHybrid no WLS weight"),
        "GeoHybrid-CoarseOnly64": dict(color="#b15928", marker="s", linestyle=":", linewidth=1.15,
                                       label="GeoHybrid coarse-only"),
        "GeoHybrid-FineOnly64": dict(color="#74c476", marker="H", linestyle=":", linewidth=1.15,
                                     label="GeoHybrid fine-only"),
        ...
        "FreqDAE-v4-CR4": dict(color="#67001f", marker="*", linestyle="-", linewidth=1.45,
                               label="FreqDAE v4 CR=4"),
        "FreqDAE-v4-CR8": dict(color="#b2182b", marker="P", linestyle="--", linewidth=1.40,
                               label="FreqDAE v4 CR=8"),
        "FreqDAE-v4-CR16": dict(color="#ef8a62", marker="X", linestyle="-.", linewidth=1.35,
                                label="FreqDAE v4 CR=16"),
