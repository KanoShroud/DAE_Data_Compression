...
from research_code.shared.baselines import HadamardProjectionBaseline
from research_code.dae_pipeline.evaluate import run_urban_method_comparison
from research_code.dae_pipeline.export_results import export_method_baselines
from research_code.dae_pipeline.model import DAE, NestedFrequencyPairwiseDAE
...
DEFAULT_OUTPUT_ROOT = _LAYOUT_ROOT / "运行结果"
...
def run_go_no_go(args) -> Path:
    ...
    if not source_result.exists():
        source_result = _latest_result_dir(_LAYOUT_ROOT / "运行结果")
