...
from research_code.dae_pipeline.evaluate import (plot_snr_comparison, plot_snr_comparison_multi,
...
# ========== 在此修改结果目录路径 ==========
RESULT_DIR = os.path.join(str(_LAYOUT_ROOT), "运行结果/论文复现与传统基线/20260702_000925_论文复现v3.1")
# ==========================================
