...
from research_code.brsr.observability.audit_oracles import (  # noqa: E402
    audit_oracles,
)
from research_code.brsr.observability.certificate import (  # noqa: E402
    STATIC_BASELINES,
...
from research_code.brsr.observability.features import (  # noqa: E402
...
def _source_hashes() -> dict[str, str]:
    paths = (
        ROOT / "research_code/brsr/observability" / "audit_oracles.py",
        ROOT / "research_code/brsr/observability" / "certificate.py",
        ROOT / "research_code/brsr/observability" / "features.py",
        ROOT / "research_code/brsr/observability" / "run_certificate.py",
    )
    return {
