...
from research_code.brsr.stage_ab.brsr_core import (  # noqa: E402
    BayesianSpectralModel,
    NestedComplexQuantizer,
    tau_posterior,
)
from research_code.brsr.stage_ab.brsr_stage_b import (  # noqa: E402
    StageBObservation,
    state_from_levels,
)
from research_code.brsr.stage_ab.brsr_waveform import WaveformConfig, observe_trial  # noqa: E402
...
def _source_hashes() -> dict[str, str]:
    paths = (
        Path(__file__),
        ROOT / "research_code/brsr/stage2" / "stage2a.py",
