...
```text
research_code/brsr/stage2/run_stage2a.py
```
...
D:\Software\anaconda3\envs\PyTorch\python.exe `
  research_code/brsr/stage2\run_stage2a.py --mode smoke
```
...
```text
research_code/brsr/stage2/diagnose_stage2a_failures.py
```
...
```text
research_code/brsr/stage2/run_stage2a1.py
```
...
```text
research_code/brsr/stage2/diagnose_stage2a1_protocol.py
```
