...
from research_code.brsr.observability.run_certificate import (  # noqa: E402
    _source_hashes as observability_source_hashes,
)
from research_code.brsr.stage1.run_stage1 import (  # noqa: E402
    Tee,
...
def _source_hashes() -> dict[str, str]:
    paths = (
        ...
        ROOT / "research_code/brsr/state_oracle" / "README.md",
    )
    return {
