...
from research_code.brsr.stage1.feasibility import (  # noqa: E402
    PoolName,
    action_levels,
...
from research_code.brsr.stage_ab.brsr_core import NestedComplexQuantizer, tau_posterior  # noqa: E402
from research_code.brsr.stage_ab.brsr_stage_b import evaluate_fixed, state_from_levels  # noqa: E402
from research_code.brsr.stage_ab.brsr_waveform import (  # noqa: E402
    StructuredTrial,
    WaveformConfig,
...
RUNTIME_SOURCE_FILES = {
    "research_code/brsr/stage1/feasibility.py",
    "research_code/brsr/stage_ab/brsr_core.py",
    "research_code/brsr/stage_ab/brsr_stage_b.py",
    "research_code/brsr/stage_ab/brsr_waveform.py",
}
NON_RUNTIME_SOURCE_FILES = {
    "research_code/brsr/stage1/run_stage1.py",
}
METRIC_COLUMNS = (
    "seed",
    "trial",
            ...
            manifest = {
                ...
                "source_files": {
                    ...
                    for path in (
                        ...
                        ROOT / "research_code/brsr/stage1" / "feasibility.py",
                        ROOT / "research_code/brsr/stage1" / "run_stage1.py",
                        ROOT / "research_code/brsr/stage_ab" / "brsr_core.py",
                        ROOT / "research_code/brsr/stage_ab" / "brsr_stage_b.py",
                        ROOT / "research_code/brsr/stage_ab" / "brsr_waveform.py",
                    )
                },
            }
