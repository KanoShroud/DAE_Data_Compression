...
from research_code.brsr.stage1.feasibility import (
    action_levels,
    base_levels,
...
from research_code.brsr.stage1.run_stage1 import (
    QUADRATURE_DIAGNOSTIC_GRIDS,
    QUADRATURE_REFERENCE_GRID,
    _gate,
)
from research_code.brsr.stage_ab.brsr_core import NestedComplexQuantizer
from research_code.brsr.stage_ab.brsr_stage_b import evaluate_fixed
from research_code.brsr.stage_ab.brsr_waveform import (
    WaveformConfig,
