...
from research_code.brsr.stage1.run_stage1 import Tee  # noqa: E402
from research_code.brsr.stage2.run_stage2a import (  # noqa: E402
    PRIMARY_LIKELIHOOD,
    PRIMARY_POOL,
    QUANTIZER_BITS,
    QUANTIZER_CLIP_ABS,
)
from research_code.brsr.stage2.run_stage2a1 import (  # noqa: E402
    _build_frozen_model,
    _source_seed_set,
)
from research_code.brsr.stage2.stage2a import (  # noqa: E402
    rate_match_assignments,
)
from research_code.brsr.state_oracle.certificate import (  # noqa: E402
...
from research_code.brsr.state_oracle.run_certificate import (  # noqa: E402
    _base_metadata,
    _load_frozen_source_line_ending_safe,
    _observation,
)
from research_code.brsr.precision_replication.replication import (  # noqa: E402
    BASELINES,
    TARGET_METHOD,
    gate_decision,
    paired_effects,
...
from research_code.brsr.stage_ab.brsr_core import NestedComplexQuantizer  # noqa: E402
from research_code.brsr.stage_ab.brsr_waveform import WaveformConfig  # noqa: E402
...
SOURCE_RESULT_SHA256 = {
    "manifest.json": "3aeb683fcd6236708c894d03ca46d45819e946c0fd19be6fe75466ff87cb88f3",
...
def _source_hashes() -> dict[str, str]:
    paths = (
        ROOT / "research_code/brsr/precision_replication" / "replication.py",
        ROOT / "research_code/brsr/precision_replication" / "run_replication.py",
        ROOT / "research_code/brsr/precision_replication" / "README.md",
        ROOT / "research_code/brsr/state_oracle" / "certificate.py",
        ROOT / "research_code/brsr/state_oracle" / "run_certificate.py",
    )
    return {
