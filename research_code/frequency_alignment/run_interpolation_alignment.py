...
PROJECT_DIRECTORY = _LAYOUT_ROOT
...
try:  # 支持 ``python -m standalone_frequency_alignment...`` 方式导入。
    ...
    from research_code.frequency_alignment.alignment_core import (  # noqa: E402
        complete_spectrum,
        complex_correlation,
        complex_nmse_db,
        estimate_continuous_delay,
    ...
    from research_code.frequency_alignment.experiment_config import ExperimentConfig, get_profile  # noqa: E402
    from research_code.frequency_alignment.plot_alignment_results import save_summary_figures  # noqa: E402
    from research_code.frequency_alignment.zhai_selection import select_zhai_thesis  # noqa: E402
...
def run_experiment(config: ExperimentConfig) -> Path:
    ...
    if config.profile.startswith("project_"):
        from research_code.frequency_alignment.project_adapter import generate_project_pairs
    ...
    manifest = {
        "route": "research_code/frequency_alignment",
