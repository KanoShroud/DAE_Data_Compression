...
from research_code.raptq.core import (  # noqa: E402
    BayesianRAPTQModel,
    ModelConfig,
    ObservationContext,
    posterior_total_variation,
)
from research_code.raptq.sparse_integrator import SparseRAPTQIntegrator  # noqa: E402
...
def _validate_source_results() -> tuple[dict[str, object], dict[str, str]]:
    ...
    current_certification_hash = _source_hash(
        (
            ROOT / "research_code/raptq" / "diagnose_sparse_integrator.py",
            ROOT / "research_code/raptq" / "sparse_integrator.py",
            ROOT / "research_code/raptq" / "core.py",
        )
    )
